...
export interface ModalProps
  extends Omit<BaseModalProps, 'role' | 'renderBackdrop' | 'renderDialog' | 'transition' | 'backdropTransition'> {
  size?: 'sm' | 'lg' | 'xl'
...
declare const _default: BsPrefixRefForwardingComponent<'div', ModalProps> & {
  ...
  Header: React.ForwardRefExoticComponent<
    import('./ModalHeader').ModalHeaderProps & React.RefAttributes<HTMLDivElement>
  >
  ...
  Dialog: React.ForwardRefExoticComponent<
    import('./ModalDialog').ModalDialogProps & React.RefAttributes<HTMLDivElement>
  >
